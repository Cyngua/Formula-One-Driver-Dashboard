function createScatterPlot() {
    ...
    d3.csv("../data/F1_driver_dataset.csv", rowConverter).then((data)=>  {
        drawScatterPlot(svg, data, w, h, margin, 2020);
        window.scatterData = data;
    })
}

// a separate function to draw scatter plot
function drawScatterPlot(svg, data, w, h, margin, decade) {
    // filter data based on slider choice
